...
<html lang="ja">
    <head>
        <meta charset="UTF-8">
        <link href="mae-test.css" rel="stylesheet" type="text/css" media="all">
    ...
    <body>
        <header id = "hea">
            ...
            <!--<input type="submit" style="z-index: 5; position: absolute; right: 10%" value="質問する" class="situmon">-->
        </header>
        </header>
                ...
                <nav>
                    <section>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <?php endif; ?>
                            <div class="honbun"><span class="label">本文:</span><textarea name="comment" cols="80" rows="40" wrap="hard" placeholder="質問内容を入力してください。"></textarea></div>
                            ...
                            <input type="submit" style="z-index: 5; position: fixed; right: 10%" value="質問する" class="situmon">
                ...
                <label for="ck<?=$counter?>"></label>
                    <div id="doc<?=$counter?>">
                        <?php if($posts->rowCount() > 0): ?>
                            <ul>
                                <li>
                                        <img src=http://noobs.php.xdomain.jp/iine/iine.png></img>
                                        <h2><?=$post['yomiyasuine']?>
                                        <?=$post['title']?></h2>
                                        本文：
                                        <a><?=$post['message']?>
